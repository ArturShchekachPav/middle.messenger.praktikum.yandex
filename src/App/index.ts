...
import {LoginPage, MessangerPage, SettingsPage, RegistrationPage, ErrorPage} from "../pages";
import './style.scss';
	...
	enable() {
		this.router
			...
			.use(
				...
				SettingsPage,
				{},
				protectUnauthorizedUsers(Route)
			)
			.use(
				"/messanger",
				MessangerPage,
