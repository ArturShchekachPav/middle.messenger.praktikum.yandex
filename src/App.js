	...
	render() {
		switch (this.currentPage) {
			case '/':
				...
				this.appElement.replaceWith(messangerPage.getContent());
				break;
			case '/profile':
			...
			case '/sing-up':
				...
				this.appElement.replaceWith(registrationPage.getContent());
				break;
			case '/sing-in':
			...
			case '/500':
				...
				this.appElement.replaceWith(serverErrorPage.getContent());
				break;
			default:
